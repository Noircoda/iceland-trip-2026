...
export const BOOKINGS: CheckItem[] = [
  ...
  { id: 'bk-zodiac', label: 'Jökulsárlón 冰河湖船遊（Zodiac）', detail: '7/15（三）16:30 場・Zodiac 常售罄；Amphibian 可現場', due: '行前 1–2 週', url: 'https://icelagoon.is', urgency: 2 },
...
export const GROCERIES: GroceryStop[] = [
  ...
  { id: 'g-d9', day: 9, store: '市區超市＋Asian Supermarket', when: 'D9 下午（亞超 18:00 關）', hours: 'Vietnam Market 週一 11–18', supplies: 'D10 早餐＋糖果巧克力伴手（超市買最划算）' },
];
