...
export const BOOKINGS: CheckItem[] = [
  { id: 'bk-glacier', label: 'Sólheimajökull 冰川健行', detail: '7/14（二）09:30 出團（3h；亦有 10:30 場）・或改黑沙灘 ATV 二選一', due: '行前 1–2 週', url: 'https://troll.is/tour/solheimajokull-3-hour-glacier-hike/', urgency: 1 },
  { id: 'bk-horse', label: 'Icelandic Horse Tours 騎馬', detail: '7/18（六）14:30 場・預約制：+354 847 8577 / info@icelandhorsetours.com', due: '行前 1–2 週', url: 'https://icelandhorsetours.com/en/riding-tours-around-helluland/', urgency: 1 },
  ...
  { id: 'bk-skylagoon', label: 'Sky Lagoon 海崖溫泉', detail: '7/20（一）16:45 場', due: '行前 3–7 天', url: 'https://www.skylagoon.com', urgency: 2 },
  { id: 'bk-vatnshellir', label: 'Vatnshellir 熔岩洞導覽', detail: '7/19（日）16:00 場（45 分・最晚 15:50 報到）', due: '行前 1–2 週', url: 'https://www.summitguides.is/vatnshellir-cave-tour', urgency: 2 },
  ...
  { id: 'bk-fridheimar', label: 'Friðheimar 蕃茄農場', detail: '7/13（一）午餐・buffet 提前試訂；訂不到走現場 winebar（免訂）', due: '可提前試訂', url: 'https://www.dineout.is/fridheimar', urgency: 3 },
  { id: 'bk-restaurants', label: '餐廳訂位（旺季建議）', detail: 'Suður-Vík 7/14、Vogafjós 7/17、Sjávarborg 7/18（21:00 最後點餐）、Messinn 7/20', due: '行前數天', urgency: 3 },
  { id: 'bk-boat', label: '冰河湖遊船（已訂）', detail: '7/15（三）15:20–16:00 水陸兩棲船・提前 20 分到湖畔咖啡館換票', due: '已完成', urgency: 3 },
];
...
export const PREP: CheckItem[] = [
  ...
  { id: 'p-ba', label: 'BA801 線上報到＋確認行李規定', detail: 'D10 早班機，07:25 進航廈（7 月安檢尖峰）' },
