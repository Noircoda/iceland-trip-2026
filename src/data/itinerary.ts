...
export const DAYS: Day[] = [
  ...
  },
  {
    ...
    hardDeadlines: ['船遊 16:30 班次', 'Pakkhús 21:00 最後點餐'],
    flexNotes: ['落後 30 分 → 砍 Fjallsárlón；落後 1 小時 → 船改 Amphibian 短版或岸上看', 'Skaftafell 停車用 Parka 同卡付，冰河湖停車半價'],
    stops: [
      { id: 'd4-eldhraun', name: '埃爾德熔岩原', nameLocal: 'Eldhraun', type: '景點', icon: '🍃', coord: [-18.25, 63.42], timeStart: '09:15', timeEnd: '09:30', driveFromPrev: { km: 78, min: 62 }, desc: '1783 年 Laki 大噴發形成、覆滿厚苔蘚的熔岩原，路邊觀景點快拍。', tips: ['勿踩苔蘚（數十年才長回）'], cutPriority: 1 },
      ...
      { id: 'd4-skaftafell', name: 'Skaftafell：黑瀑布健行＋午餐', nameLocal: 'Svartifoss', type: '景點', icon: '🥾', coord: [-16.9753, 64.0275], routeCoord: [-16.9667, 64.0166], timeStart: '12:00', timeEnd: '14:25', driveFromPrev: { km: 70, min: 65 }, desc: '玄武岩管風琴峭壁環抱的黑瀑布。遊客中心出發來回 3.4km／爬升 140m／1.5–2h，途經 Hundafoss。', tips: ['停車 1,000 ISK/日', '午餐：自備三明治（前晚 Vík 採買）或園區簡餐'], badges: ['自理'] },
      ...
      { id: 'd4-jokulsarlon', name: '傑古沙龍冰河湖＋船遊', nameLocal: 'Jökulsárlón', type: '活動', icon: '🚤', coord: [-16.2306, 64.0784], timeStart: '16:00', timeEnd: '18:00', driveFromPrev: { km: 10, min: 10 }, desc: '巨型冰山漂浮的冰川潟湖。16:30 船遊：Zodiac 快艇 75 分深入冰川壁，或 Amphibian 水陸船 40 分。', tips: ['⚠️ Zodiac 提前 1–2 週訂（~17,000 ISK，10 歲+）；Amphibian ~7,100 ISK 彈性大', '停車 1,000 ISK（Parka 同卡有 Skaftafell 折抵）'], badges: ['需預約'], links: { booking: 'https://icelagoon.is' } },
      { id: 'd4-diamond', name: '鑽石冰沙灘', nameLocal: 'Diamond Beach', type: '景點', icon: '💎', coord: [-16.1777, 64.0443], timeStart: '18:05', timeEnd: '18:40', driveFromPrev: { km: 2, min: 5 }, desc: '冰山碎塊被海浪推回黑沙灘，像散落的鑽石——出海口對面即達。' },
      { id: 'd4-pakkhus', name: '晚餐：Pakkhús 海螯蝦', nameLocal: 'Pakkhús', type: '餐廳', icon: '🦞', coord: [-15.2014, 64.2496], timeStart: '19:55', timeEnd: '21:00', driveFromPrev: { km: 78, min: 70 }, desc: 'Höfn 港邊倉庫改建的海螯蝦（langoustine）名店。', tips: ['不收訂位→直接進候位（樓下酒吧等位）', '21:00 最後點餐', '備援：Hafnarbúðin 龍蝦堡（平價）、Ottó'], rating: 4.5, price: '海螯蝦主餐 ~8,000 ISK' },
      { id: 'd4-lodging', name: '夜宿：Höfn', nameLocal: 'Sveitarfélagið Hornafjörður', type: '住宿', icon: '🏠', coord: [-15.2082, 64.2539], walk: true, timeStart: '21:10', desc: '龍蝦小鎮 Höfn 過夜。', tips: ['座標為鎮中心近似值'] },
    ],
  },
  {
    ...
    stops: [
      ...
      { id: 'd5-egilsstadir', name: '補給：Egilsstaðir 加油＋Nettó', nameLocal: 'Egilsstaðir', type: '採買', icon: '⛽', coord: [-14.4097, 65.2669], timeStart: '14:45', timeEnd: '15:30', driveFromPrev: { km: 143, min: 110 }, desc: '東部最大補給樞紐：加滿油＋採買今晚自炊與 D6 早午餐食材。', hours: 'Nettó 09:00–20:00' },
  ...
  },
  {
    ...
    flexNotes: ['全程最重的一天：趕→先砍 Hverfjall/Dimmuborgir、再砍 Selfoss、Krafla 縮短', '鬆版：溫泉改 Akureyri 的 Forest Lagoon 晚場 → 19:30 Goðafoss、20:30 抵 Akureyri'],
    stops: [
  ...
  },
  {
    ...
    stops: [
      ...
      { id: 'd8-londrangar', name: 'Lóndrangar 怪物海岸', nameLocal: 'Lóndrangar', type: '景點', icon: '🗿', coord: [-23.7846, 64.7325], timeStart: '18:05', timeEnd: '18:25', driveFromPrev: { km: 8, min: 8 }, desc: '75m 火山岩塔海崖（古火山栓），觀景台快拍。Malarrif 遊客中心有免費廁所。' },
  ...
  },
  {
    ...
    hardDeadlines: ['Asian Supermarket 18:00 關（先去）', 'Sky Lagoon 16:45 場', 'Messinn 21:00 關（19:45 訂位）'],
    ...
    stops: [
      ...
      { id: 'd9-asianmarket', name: '亞洲超市', nameLocal: 'Vietnam Market', type: '採買', icon: '🍜', coord: [-21.8649, 64.1287], timeStart: '13:00', timeEnd: '13:40', driveFromPrev: { km: 75, min: 60 }, desc: '進城第一站：補亞洲食材與泡麵（18:00 關門）。', hours: '週一 11:00–18:00' },
      { id: 'd9-checkin', name: 'Check-in：雷克雅維克市區', nameLocal: 'Reykjavík Airbnb', type: '住宿', icon: '🏠', coord: [-21.93, 64.145], timeStart: '13:45', timeEnd: '14:15', driveFromPrev: { km: 5, min: 12 }, desc: '放行李＋停車（P2 230 ISK/h，09:00–21:00 收費）。', tips: ['座標為市中心近似值，可貼 Airbnb 連結更新'] },
      { id: 'd9-shopping', name: '購物時段：Laugavegur＋彩虹街', nameLocal: 'Laugavegur', type: '採買', icon: '🛍️', coord: [-21.9126, 64.143], walk: true, timeStart: '14:15', timeEnd: '16:15', desc: '伴手禮主戰場：66°North、Icewear、書店、Brauð & Co 肉桂捲（下午場售完看緣分）；糖果巧克力在超市買最划算。順買明天早餐。', tips: ['滿 12,000 ISK 留收據退稅', '記得買 D10 早餐（自理）'], badges: ['自理'] },
  ...
  },
  {
    ...
    hardDeadlines: ['BA801 10:20 起飛（07:45 進航廈）'],
    flexNotes: ['退稅在「託運行李之前」辦（入境大廳 Prosegur 櫃檯，04:30 起營業）', '早餐＝前晚買好，車上/航廈吃'],
    stops: [
      { id: 'd10-depart', name: '出發（早餐自理）', nameLocal: 'Reykjavík → KEF', type: '交通', icon: '🌅', coord: [-21.93, 64.145], timeStart: '06:15', desc: '05:15 起床、06:15 上路，清晨無車流 45–50 分到機場。', badges: ['自理'] },
      { id: 'd10-fuel', name: '加滿油：Orkan Njarðvík', nameLocal: 'Orkan', type: '加油', icon: '⛽', coord: [-22.544, 63.974], timeStart: '07:00', timeEnd: '07:15', driveFromPrev: { km: 47, min: 45 }, desc: '還車前加滿（租車條件），機場旁自助站。' },
      { id: 'd10-return', name: '還車＋退稅＋登機', nameLocal: 'KEF Airport', type: '交通', icon: '✈️', coord: [-22.6056, 63.985], timeStart: '07:20', timeEnd: '10:20', driveFromPrev: { km: 5, min: 7 }, desc: '07:20 還車＋接駁 → 07:45 進航廈 → 先退稅（Prosegur 櫃檯）再託運 → BA801 10:20 起飛，14:25 抵倫敦希斯洛。', tips: ['單張收據滿 12,000 ISK 才可退稅', '起飛前 2.5h 進航廈＝內建 30–45 分緩衝'] },
    ],
  },
];
